  ...
  <AuthContext.Provider value={{
    ...
    <NavigationContainer ref={navigationRef}>
      <Stack.Navigator>
        {state.isLoading ? (
        ...
        ) : state.userToken != null && state.userType.includes('Sale', 'WareHouse') ? ( // If user is Sale
              <React.Fragment>
                <Stack.Screen
                  name="HomeScreen"
                  component={Home}
                ...
                <Stack.Screen
                  ...
                  options={{ 
                    ...
                    headerTintColor: '#6633FF',
                    headerLeft: () => (
                      <TouchableOpacity                
                        onPress={() => navigationRef.current?.goBack()}>
                        <Icon style = {{paddingLeft : 10}} name="chevron-left-circle" size={26} color="#6633FF" />
                      </TouchableOpacity>
                    ),
                }}/>
          ...
          ): state.userToken != null &&  JSON.stringify(state.userType).includes('WareHouse') ? ( // If user is WareHouse
          ...
          ) : state.userToken != null && state.userType.includes('Sale') ? ( // If user is Sale only
            <React.Fragment>
              <Stack.Screen
                name="HomeScreen"
                component={Home}
